...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL,   KC_ENT, KC_LGUI, KC_LALT, MO(_FIRST),KC_SPC,KC_SPC, MO(_SECOND),KC_LEFT,	KC_DOWN,	KC_UP,    	KC_RGHT
    ), 
	...
	[_SECOND] = LAYOUT_ortho_4x12(
        ...
        KC_LSFT,   KC_1,    KC_2,    KC_3,    KC_0, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,   	KC_TRNS,   	KC_TRNS,
